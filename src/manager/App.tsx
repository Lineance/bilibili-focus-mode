...
export function App() {
  const [activeTab, setActiveTab] = useState<'limbo' | 'cooling' | 'instant' | 'permanent' | 'ghost' | 'debt' | 'uploaders' | 'keywords' | 'config'>('limbo');
...
// Time Window Fuse Button Component
function TimeWindowFuseButton({ onFuseApplied }: { onFuseApplied: () => void }) {
...
// Keyword Rules Management Panel
function KeywordRulesPanel({ config }: { config: ExtensionConfig }) {
